...
class StockPicking(models.Model):
    ...
    def partner_origin(self):
        ...
        mrp_production_obj = self.env['mrp.production'].search([('name', 'like', self.origin)])
    ...
    def _compute_mrp_shift(self):
        for pick in self:
            ...
            mrp_production_obj = self.env['mrp.production'].search([('name', 'like', pick.origin)], limit=1)
