...
class AccountMove(models.Model):
    ...
    def _post(self, soft=True):
        ...
        for move in to_post:
            if move.line_ids.filtered(lambda line: not line.display_type):
            ...
            if not move.invoice_date and move.is_invoice(include_receipts=True):
                ...
                move.with_context(check_move_validity=False)._quick_edit_mode_suggest_invoice_date()
        ...
        for move in to_post:
            ...
            if move._get_invoice_reference_odoo_partner():
                to_write = {
        ...
        to_post._check_balanced(container)
        return to_post
